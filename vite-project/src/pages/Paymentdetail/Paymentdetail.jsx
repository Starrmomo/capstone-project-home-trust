...
//   // 🔙 BACK BUTTON → Secure Checkout
//   const handleBack = () => {
//     navigate("/securecheckout"); // make sure this matches your route
//   };

//   // 💳 PAY BUTTON → Payment Receipt Page
//   const handlePay = () => {
//     if (!isValid) return;

//     navigate("/payment-receipt"); // this is your receipt page route
//   };
...
export default function PaymentDetails() {
  ...
  // ✅ Validate form (button enables if any text is entered in all fields)
  useEffect(() => {
    const valid =
  ...
  const handlePay = () => {
    ...
    // Navigate to a "payment receipt" page
